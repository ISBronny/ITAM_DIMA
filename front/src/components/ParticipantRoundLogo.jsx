    ...
    return (
        <>
            ...
            <div className="flex items-center">
                {members.map(h =>
                    <div className="mt-2 mb-2 -ml-1 relative inline-flex items-center justify-center w-10 h-10 overflow-hidden rounded-full dark:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
